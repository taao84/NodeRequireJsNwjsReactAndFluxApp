  ...
  var transform = {
    ...
    ReactTools: function (name, parentRequire, onLoadNative, config) {
      var fs = requirejs.nodeRequire('fs'),
        ReactTools = requirejs.nodeRequire('react-tools'),
        compiled = void 0;

      var nameWithFileExtension =  ensureJSXFileExtension(name, config)
      var path = parentRequire.toUrl(nameWithFileExtension);
